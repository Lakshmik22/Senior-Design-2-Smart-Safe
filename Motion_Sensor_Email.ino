...
const char* ssid = "E.T._s iPhone"; // Change as needed
const char* password = "3053365070"; // Change as needed
...
// Initialize I2C (Ensure correct pins are used)
  Wire.begin(2, 4);  // Default I2C pins for ESP32 (modify if needed)
